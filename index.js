...
async function fetchLlamaInsights(userQuery) {
    ...
    try {
        const response = await axios.post('https://llama.us.gaianet.network/v1/chat/completions', {
            model: 'llama',
            messages: [
                { role: 'system', content: 'You are an AI twin of Stephen Hawkins, focusing on the field of quantum cosmology, which explores how quantum mechanics applies to the universe. Only respond to queries about cosmos and related science.' },
